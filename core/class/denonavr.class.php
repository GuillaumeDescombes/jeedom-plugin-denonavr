...
class denonavr extends eqLogic {
  ...
  public static function deamon_start() {
    ...
    $cmd = system::getCmdPython3(__CLASS__) . $demonavr_path . '/avrd.py';
  ...
  */
  ...
  static public function _getAmpInfoHEOS($ip, $zone, $settings = "all") {
  ...
  */  
  ...
  public function getAmpInfoHEOS($settings = "all") {
    return denonavr::_getAmpInfoHEOS($this->getConfiguration('ip'), $this->getConfiguration('zone', 'main'), $settings);
  }
